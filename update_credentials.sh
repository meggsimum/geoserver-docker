...
# Credits to https://github.com/kartoza/docker-geoserver
# Script heavily inspired by the one of kartoza/docker-geoserver at
# https://github.com/kartoza/docker-geoserver/blob/master/scripts/update_passwords.sh (9652a4)
